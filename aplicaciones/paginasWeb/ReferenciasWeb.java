...
public class ReferenciasWeb implements Comparable<ReferenciasWeb>  {
    ...
    public boolean equals(Object o) {
        ...
        return res;
        */
        return o instanceof ReferenciasWeb && this.url.equals(((ReferenciasWeb) o).url);
    ...
    public int compareTo(ReferenciasWeb ref) {
        if(this.nohref == ref.nohref) return this.nolineas - ref.nolineas ;
        return ref.nohref-this.nohref;
    }
